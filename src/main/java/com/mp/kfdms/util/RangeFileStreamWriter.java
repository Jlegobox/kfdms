...
public class RangeFileStreamWriter {
     ...
     */
    public static int writeRangeFileStream(HttpServletRequest request, HttpServletResponse response, File fo, String fileName,
        ...
        // 设置请求头，推荐使用application/octet-stream
